...
<div class=" md:flex h-[82vh] mx-6">
    <form method="post" class="mx-6">
        <div class="rounded-md shadow-sm">
            ...
            <input type="text" bind:value={latitude} id="latitude" name="latitude" placeholder="51.505" class="rounded-md shadow-sm text-sm px-3 py-1 text-neutral-700 hover:ring-1 focus:ring-1 ring-gray-500" required>
        </div>

        <div class="rounded-md shadow-sm mt-3">
            <label for="longitude" class="text-sm font-medium text-gray-400 block">Longitude:</label>
            <input type="text" bind:value={longitude} id="longitude" name="longitude" placeholder="-35.603" class="rounded-md shadow-sm text-sm px-3 py-1 text-neutral-700 hover:ring-1 focus:ring-1 ring-gray-500" required>
        </div>

        <div class="rounded-md shadow-sm mt-3">
            <label for="radius" class="text-sm font-medium text-gray-400 block">Radius:</label>
            <input type="text" bind:value={radius} id="radius" name="radius" placeholder="200" class="rounded-md shadow-sm text-sm px-3 py-1 text-neutral-700 hover:ring-1 focus:ring-1 ring-gray-500" required>
        </div>

        <div class="rounded-md shadow-sm mt-3">
            <label for="note" class="text-sm font-medium text-gray-400 block">Note:</label>
            <input type="text" bind:value={note} id="note" name="note" placeholder="Known Place" class="rounded-md shadow-sm text-sm px-3 py-1 text-neutral-700 hover:ring-1 focus:ring-1 ring-gray-500">
        </div>

        <div class="rounded-md shadow-sm mt-3">
            <label for="color" class="text-sm font-medium text-gray-400 block">Color:</label>
            <input type="color" bind:value={color} id="color" name="color" class="rounded-md shadow-sm text-sm px-3 w-full py-1 text-neutral-700 hover:ring-1 focus:ring-1 ring-gray-500">
        </div>
